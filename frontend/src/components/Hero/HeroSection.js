...
//           </a>
//           <a
//             href="/media/docs/Ankush_Choudhary_CV.pdf"
//             download
...
// <div className="absolute inset-0 flex items-center justify-center z-20 perspective-3d">
//   <div className="relative w-full h-full orbit-group transition-transform duration-1000 hover:rotate-y-180">
//     <img
//       src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg"
//       alt="React"
//       title="React"
//       className="absolute top-0 left-1/2 w-8 -translate-x-1/2 orbit-icon"
//     />
//     <img
//       src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg"
//       alt="Node.js"
//       title="Node.js"
//       className="absolute right-0 top-1/2 w-8 -translate-y-1/2 orbit-icon"
//     />
//     <img
//       src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg"
//       alt="MongoDB"
//       title="MongoDB"
//       className="absolute bottom-0 left-1/2 w-8 -translate-x-1/2 orbit-icon"
//     />
//     <img
//       src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg"
//       alt="Java"
//       title="Java"
//       className="absolute left-0 top-1/2 w-8 -translate-y-1/2 orbit-icon"
//     />
//     <img
//       src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg"
//       alt="Spring Boot"
//       title="Spring Boot"
//       className="absolute top-4 left-4 w-8 orbit-icon"
//     />
//     <img
//       src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg"
//       alt="MySQL"
//       title="MySQL"
//       className="absolute bottom-4 right-4 w-8 orbit-icon"
//     />
//     <img
//       src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg"
//       alt="GitHub"
//       title="GitHub"
//       className="absolute top-4 right-4 w-8 orbit-icon"
//     />
//     <img
//       src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postman/postman-original.svg"
//       alt="Postman"
//       title="Postman"
//       className="absolute bottom-4 left-4 w-8 orbit-icon"
//     />
//   </div>
// </div>
...
//               {/* Orbit icons */}
//               {[
//                 { src: 'react', pos: 'top-0 left-1/2 -translate-x-1/2' },
//                 { src: 'nodejs', pos: 'right-0 top-1/2 -translate-y-1/2' },
//                 { src: 'mongodb', pos: 'bottom-0 left-1/2 -translate-x-1/2' },
//                 { src: 'java', pos: 'left-0 top-1/2 -translate-y-1/2' },
//                 { src: 'spring', pos: 'top-4 left-4' },
//                 { src: 'mysql', pos: 'bottom-4 right-4' },
//                 { src: 'github', pos: 'top-4 right-4' },
//                 { src: 'postman', pos: 'bottom-4 left-4' },
//               ].map(({ src, pos }) => (
//                 <img
//                   key={src}
...
//                   alt={src}
//                   title={src}
//                   className={`absolute ${pos} w-8 orbit-icon`}
//                 />
//               ))}
//             </div>
//           </div>
